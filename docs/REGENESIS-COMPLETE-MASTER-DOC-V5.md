# REGENESIS: COMPLETE MASTER DOCUMENT V5
## Vision + Strategy + Technical Architecture + Development Roadmap

*Comprehensive update incorporating pricing model, wireframe UI/UX implementations, brand refinements, and interactive dashboard features*
*January 2026*
...
6. [Corporate Admin Experience](#part-f-corporate-admin-experience)
7. [ReGenesis Permissions & Autonomy Model](#part-g-regenesis-permissions--autonomy-model)
8. [Data, Privacy & Trust Architecture](#part-h-data-privacy--trust-architecture)
9. [Agentic Client Analysis](#part-i-agentic-client-analysis)
10. [Wisdom Corpus Engine](#part-j-wisdom-corpus-engine)
11. [Technical Architecture & LLM Strategy](#part-k-technical-architecture--llm-strategy)
12. [Development Roadmap & Phasing](#part-l-development-roadmap--phasing)
13. [Brand, Design & UX](#part-m-brand-design--ux)
14. [Pricing Strategy](#part-n-pricing-strategy)
15. [Integrations Reference](#part-o-integrations-reference)
16. [Legal & Compliance Framework](#part-p-legal--compliance-framework)
17. [Wireframe & UI Implementation Status](#part-q-wireframe--ui-implementation-status)
...
- **Mobile apps for ALL user tiers** — Coach, Coachee, and Corporate Admin each have mobile functionality
...
**Visual Inspiration:** jessetorrence.com — Natural, organic, warm, human. NOT robotic, cold, or overly corporate.

**Vibe:** The brand should feel like a trusted advisor, a wise friend, a calm presence — not a clinical tool or a corporate dashboard.

---

# PART C: THE THREE USER TIERS

ReGenesis serves three distinct user types, each with their own onboarding flow and data ownership model. **Each tier has mobile app access.**
...
│  Mobile: Yes — Dashboard access, alerts, reporting          │
└─────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────┐
...
│  Mobile: Yes — Full functionality, voice-enabled            │
└─────────────────────────────────────────────────────────────┘
                              │
                              ▼
┌─────────────────────────────────────────────────────────────┐
...
│  Mobile: Yes — 24/7 companion, reflections, check-ins       │
└─────────────────────────────────────────────────────────────┘
```
...
At the bottom of the dashboard, a section for the **coach's own life** — coaching AND non-coaching:
...
**Includes non-coaching to-dos:** "Pick up birthday gift for Oana" lives alongside "Send Marcus the delegation framework." ReGenesis helps with ALL of life.
...
- **Time Keeper:** Subtle timer/notification for session pacing

#### In-Session Adjustable Controls (Future)

Real-time "dials/toggles" the coach can adjust during a session:
...
### Workflow 5: 24/7 Coachee Companion & Full Conversation Log
...
#### Client Page: Full Companion Conversation Log

On each client's page in the coach's view, there's a **full log of ALL 24/7 companion conversations** — not just a summary. This allows coach to:
...
Jan 10, 2026 — 11:30pm (5 min)
├── Topic: Late-night reflection
├── T-15 Summary: Unusually vulnerable journal entry
├── [Expand full transcript]
└── [Jump to specific moments]
...
**T-15 Summary Integration:** Each conversation has a T-15-style summary (the AI's synthesis of key themes, emotional moments, patterns) that auto-populates the T-15 prep for the next session.

**24/7 Chatbot Timing:** The coachee companion is available from **MVP/Phase 1** — this is a core differentiator, not a future feature.

---

## Client List Page

The coach's main view shows **all clients** with key information at a glance:
...
┌─────────────────────────────────────────────────────────────────┐
│ Sarah Williams                                 Next: Tomorrow   │
│ Director Engineering @ StartupCo                                │
│ Focus: Work-life balance, boundary setting                      │
│ Status: 🟢 Thriving — completed all commitments, breakthrough   │
│ [Open Profile] [T-15 Prep] [Quick Note]                         │
└─────────────────────────────────────────────────────────────────┘

┌─────────────────────────────────────────────────────────────────┐
│ David Kim                                      Next: Friday     │
│ Founder @ NewVenture                                            │
│ Focus: Founder burnout, delegation                              │
│ Status: 🟠 Check-in needed — no companion activity in 2 weeks   │
│ [Open Profile] [T-15 Prep] [Quick Note]                         │
└─────────────────────────────────────────────────────────────────┘
```
...
Full calendar view integrated with coach's scheduling:
...
│                                                                     │
│ Fri 23                                                              │
│  └── 11:00am - David Kim (Founder coaching)                         │
│       └── [T-15 Prep: Needs attention] [Join Zoom]                  │
└────────────────────────────────────────────────────────────────────┘
...
- **Quick actions:**
  ...
  - "Remind me to pick up Oana's birthday gift" (non-coaching to-do)
...
Voice matching refers to **written tone**, not audio (though future versions may include actual voice cloning/avatars). Coach feeds ReGenesis their past notes, emails, text messages, and other writing samples during onboarding to train the voice profile.
...
**Future Vision:** Actual voice cloning for audio/video messages, AI avatars for asynchronous coaching content.
...
- Billing: Square, Stripe, PayPal, Venmo, Zelle
...
## Coachee Progress Tracking & Trends

ReGenesis tracks coachee progress at multiple levels:
...
Full 24/7 companion access on mobile:

- **Chat interface** — Talk to ReGenesis anytime
- **Voice interaction** — Speak reflections, get responses
- **Commitment tracking** — See and update your commitments
- **Session notes access** — Review past sessions
- **Resource library** — Access all shared materials
- **Journal/reflection** — Capture thoughts between sessions
...
# PART F: CORPORATE ADMIN EXPERIENCE

## What Corporate Admins See

Corporate admins (HR, L&D, program owners) have a dashboard focused on **aggregate, anonymized** data:

```
📊 COACHING PROGRAM DASHBOARD

Program Overview
├── Active coachees: 47 / 50 seats
├── Average engagement: 87%
├── Sessions this month: 142
└── Coach utilization: 94%

ROI Indicators (Anonymized)
├── Goal completion rate: 73%
├── Engagement trend: ↗️ +12% vs. last quarter
├── Theme distribution: Leadership (34%), Communication (28%), Work-life (21%), Other (17%)
...
## What Corporate Admins CANNOT See

- Individual session content
- Personal goals or reflections
- Specific conversation topics
- Individual coachee progress details
- Any Tier 1 or Tier 2 data

**This is architectural, not policy.** Admin literally does not have encryption keys.

## Corporate Admin Mobile App

- Dashboard access (aggregate metrics)
- Seat management
- Program alerts (low engagement, seat utilization)
- Report scheduling

---

# PART G: REGENESIS PERMISSIONS & AUTONOMY MODEL
...
| Guarantee **complete** confidentiality from coach | Coachee knows coach has Tier 2 visibility for shared content |
...
**Clarification on Tier 5 Confidentiality:**
- Tier 1 (Private) content is FULLY confidential — coach cannot see
- Tier 2 (Coach-Shared) content — coach has visibility as the coachee has chosen to share
- ReGenesis cannot guarantee that Tier 2 content is hidden from the coach — that's the point of Tier 2
...
# PART H: DATA, PRIVACY & TRUST ARCHITECTURE
...
**Discussion Point:** This needs further specification. Third parties haven't consented, yet understanding relational dynamics is essential to coaching.
...
| Regulation | Priority | What It Signals | Phase |
|------------|----------|-----------------|-------|
| GDPR | HIGH | Gold standard for privacy | Design from Day 1 |
| SOC 2 Type II | HIGH | Enterprise requirement, independent audit | Pursue first |
| HIPAA-ready | MEDIUM-HIGH | Healthcare-grade security | Build architecture |
| ISO 27001 | MEDIUM | International security standard | Post-SOC 2 |

**Approach:** Design for GDPR from day 1, pursue SOC 2 first, build HIPAA-ready architecture.

**Phasing Detail:**
- Phase 2-3: GDPR-compliant architecture
- Phase 4: SOC 2 Type I
- Phase 5+: SOC 2 Type II, HIPAA certification

---

# PART I: AGENTIC CLIENT ANALYSIS
...
Advanced sentiment tracking over time:
...
## Legacy / Story Capture Feature

**The Vision:** Over time, ReGenesis accumulates a rich "digital exhaust" of the coachee's journey — their struggles, breakthroughs, growth, and transformation.

**The Feature:** Convert this into a meaningful legacy artifact:
- **Life story synthesis** — AI-crafted narrative of their coaching journey
...
**Phase:** 7+ (after core features mature)

---

# PART J: WISDOM CORPUS ENGINE
...
## Ever-Evolving Corpus

The Wisdom Corpus is not static — it grows and improves over time:

### Meta-Learning Architecture
- **Session Learning:** ReGenesis learns from what works in actual sessions
- **Coach Feedback:** Which suggestions were accepted, modified, rejected?
- **Outcome Correlation:** Which wisdom led to breakthroughs vs. fell flat?
- **Continuous Refinement:** Tagging and relevance scores update based on real use

### Community Contribution (Future)
- Coaches can suggest additions to the corpus
...
## Corpus Prioritization & Numbers

### MVP Phase: 100-500 Core Sources
- Highest priority for initial RAG ingestion
- Focused on coaching-specific application
- Foundational psychological frameworks

### Complete Vision: 50,000-100,000 Sources
- Full coverage across all 16 domains
- Multi-format (books, articles, videos, podcasts)
- Cross-cultural and historical depth
...
### Tier 4: Complete Corpus (500-100,000)
Long-term — full range of human wisdom literature, multimedia, and cross-cultural sources.
...
- **Polyvagal Theory** (nervous system states, window of tolerance)
- **Internal Family Systems (IFS)** (parts work, Self-leadership)
- **Nonviolent Communication (NVC)** (observations, feelings, needs, requests)
- **Limiting Beliefs Work** (identify, challenge, reframe core beliefs)
...
| NVC 4 Steps | Rosenberg | Compassionate communication |
| Limiting Beliefs | Various | Cognitive restructuring |

## Foundational Textbooks Research

**Task:** Research what textbooks are used in BA, MA, and PhD programs for training therapists and coaches. These foundational texts should be prioritized for the Wisdom Corpus.
...
# PART K: TECHNICAL ARCHITECTURE & LLM STRATEGY
...
│  │Extension │ │ Add-in   │ │ Add-in   │ │   Apps   │ │Integration│    │
│  └────┬─────┘ └────┬─────┘ └────┬─────┘ └────┬─────┘ └────┬─────┘     │
│       └────────────┴────────────┴────────────┴────────────┘            │
│                    ┌────────────▼────────────┐                         │
│                    │   Local Encryption      │                         │
...
**The Challenge:** LLMs have finite context windows. A long coaching relationship generates massive amounts of data. How do we give ReGenesis relevant context without exceeding limits?

**The Solution: Intelligent Context Assembly**
...
├── Wisdom Corpus retrieval for frameworks/quotes — top 3 chunks
├── Pattern/insight database query — relevant patterns only
└── TOTAL RETRIEVED: ~2000 tokens

REMAINING FOR GENERATION: ~3500+ tokens
```

**Key Strategies:**
1. **Summarization Chain:** Raw transcripts → Session summaries → Pattern extractions
2. **Vector Retrieval:** Only pull relevant historical content, not everything
3. **Tiered Memory:** Recent = full detail, Older = summaries, Ancient = patterns only
4. **Coachee-Consented Data Only:** Don't waste context on redacted content

**User Explanation:** "ReGenesis remembers everything, but like a wise coach, it brings forward only what's relevant to the moment."
...
# PART L: DEVELOPMENT ROADMAP & PHASING
...
| **1** | Context Reading + First Magic + 24/7 Companion | 14 | 🚧 Active |
| **1.5** | State Foundation | 7 | Planned |
| **2** | ReGenesis Actions + Notes Generation | 30+ | Planned |
| **2.5** | Navigation Commands | 4 | Planned |
| **2.7** | Scheduled Messaging | 13 | Planned |
| **3** | Web App Redesign + T-15 Prep View + Command Center | 35+ | Planned |
| **3.5** | Coach Onboarding + Voice Profile | 18+ | Planned |
| **4** | External Sites (Calendar, Gmail, Outlook) + Mobile Apps | 30+ | Planned |
| **4.5** | Coachee Layer + Privacy Tiers | 45+ | Planned |
| **5** | Pitch Polish + Demo Mode | 7+ | Planned |
| **5.5** | In-Session Real-Time Support | 10 | Planned |
| **6+** | Agentic Client Analysis + Sentiment | 35 | Vision |
| **7+** | Wisdom Corpus + Meta-Learning + Legacy Features | 40 | Vision |
...
**jessetorrence.com** — The brand should feel:
...
- **Natural greens:** (growth, renewal — from jessetorrence.com aesthetic)
...
# PART N: PRICING STRATEGY

## Core Pricing Philosophy

**"No games, no gates, no bullshit."**

ReGenesis pricing is built on radical simplicity and transparency. We believe coaching should be accessible to everyone, and our pricing reflects this core value.

### Guiding Principles

1. **Full access at every level** — No feature gating, no artificial tiers
2. **Security never tiered** — SOC 2, HIPAA, GDPR compliance for everyone
3. **Democratic access** — Competitive with Claude/ChatGPT subscriptions
4. **Honest pricing** — No "contact sales" games, no hidden fees
5. **Coaches ourselves** — We built this because we use it

---

## Pricing Tiers

### Individual Coach — $39/month

*For coaches paying out of pocket*

| What's Included | Details |
|-----------------|---------|
| **Client Capacity** | Up to 25 active clients |
| **Platform Access** | Full feature access — no gating |
| **AI Features** | Session notes, prep briefs, 24/7 companion |
| **Admin Tools** | Scheduling, invoicing, calendar integration |
| **Security** | SOC 2, HIPAA, GDPR compliant |
| **Support** | Standard support |

**Annual option:** Save 15% with annual billing

---

### Enterprise — $9/coachee/month

*For companies, coaching firms, nonprofits, government—any organization*

| What's Included | Details |
|-----------------|---------|
| **Coach Seats** | **Always free** — unlimited coaches |
| **Per-Coachee Pricing** | $9/month per active coachee |
| **Everything in Individual** | All features, no restrictions |
| **Admin Dashboard** | Aggregate analytics, program ROI |
| **SSO/SAML** | Enterprise identity integration |
| **Priority Support** | Dedicated success manager |

**Why coach seats are free:** Organizations shouldn't pay double — once for the coach, once for their access. We charge for value delivered to coachees.

---

## The "What's the Catch" Response

> **There isn't one.**
>
> We are coaches ourselves. We built ReGenesis because we believe coaching is one of the most powerful forces for human and planetary flourishing—and it's been locked behind prices that only a few can afford.
>
> We're not cheap. We're **honest**. We don't gate security behind enterprise tiers. We don't charge per feature. We don't play games with "contact sales" buttons.
>
> **Our metric isn't revenue per customer. It's human lives touched.**
>
> The more people use ReGenesis, the better off our families, communities, organizations, and ecosystems. That's the business we're in.

---

## Anti-Bullshit Guarantees

| Promise | Details |
|---------|---------|
| **No per-client fees** | For individual coaches (up to 25 clients) |
| **No usage caps** | Use it as much as you need |
| **No feature gating** | Every feature available to everyone |
| **No surprise bills** | Price is the price |
| **No data hostage** | Export your data anytime |

---

## Competitive Positioning

| Competitor | Their Model | ReGenesis Advantage |
|------------|-------------|---------------------|
| Generic AI (ChatGPT, Claude) | $20-40/month, not coaching-specific | Purpose-built for coaching, same price point |
| Coaching platforms | $100-500+/month, per-coach | Radically affordable, per-coachee for enterprise |
| Enterprise software | "Contact sales" | Transparent pricing, no games |

---

# PART O: INTEGRATIONS REFERENCE
...
| **PayPal** | P2 | Billing integration |
| **Venmo** | P2 | Billing integration (individual coaches) |
| **Zelle** | P2 | Billing integration (individual coaches) |
...
# PART P: LEGAL & COMPLIANCE FRAMEWORK
...
# PART Q: WIREFRAME & UI IMPLEMENTATION STATUS

## Overview

The interactive wireframe (`JTCoachingAppShellWireframe.jsx`) serves as the living prototype for ReGenesis. Below is the current implementation status of all major features.
...
|---------|--------|-------|
| **Header** | ✅ Complete | Superhuman-style left-aligned layout, logo + nav grouped |
| **Hero Section** | ✅ Complete | Parallax scroll effects, animated background layers |
| **For Coaches Page** | ✅ Complete | Feature categories, social proof, CTA flow |
| **Enterprise Page** | ✅ Complete | Use cases with bullet examples, security messaging, 78% goal attainment stat |
| **Pricing Page** | ✅ Complete | Individual $39, Enterprise $9/coachee, "What's the catch" section |
| **Smart CTAs** | ✅ Complete | Context-aware routing (Enterprise page → Admin onboarding) |
| **Help Chat Button** | ✅ Complete | Fixed bottom-right position |
| **Footer** | ✅ Complete | Full navigation, social links |
...
| Feature | Status | Notes |
|---------|--------|-------|
| **Alerts/Notifications Icon** | ✅ Complete | Badge showing count in header |
| **Quick Capture Bar** | ✅ Complete | "Just talk to me..." placeholder with tooltip |
| **Daily Command Center** | ✅ Complete | Sessions, tasks, priorities |
| **Sage AI Assistant** | ✅ Complete | Hover tooltip with capabilities |
...
| Feature | Status | Notes |
|---------|--------|-------|
| **Profile Tab** | ✅ Complete | LinkedIn links, personality assessments (Enneagram, DISC, MBTI, etc.) |
| **Launch Questionnaire** | ✅ Complete | Modal with filled sample data |
| **24/7 Companion Tab** | ✅ Complete | Chat log with privacy indicators, expandable sessions |
| **Goals Tab** | ✅ Complete | Vertical column layout with accordion drill-down |
| **View All Goals** | ✅ Complete | Dashboard with color-coded progress (green/yellow/red) |
| **Session Notes Tab** | ✅ Complete | List with status indicators |
| **T-15 Prep Tab** | ✅ Complete | Link to full prep page |

### Goals Layout Details

```
┌─────────────────────────────────────────────────────────────┐
│  Life Area Column (e.g., Professional Growth)               │
│  ┌─────────────────────────────────────────────────────────┐│
│  │ Goal (clickable accordion)                    Progress % ││
│  │ ├── Objective 1                                        ││
...
| Feature | Status | Notes |
|---------|--------|-------|
| **Full Editing Experience** | ✅ Complete | Clear editable fields with hover/focus states |
| **AI Assist Dropdown** | ✅ Complete | Make shorter, change tone, draft conversation, regenerate |
| **Source Attribution** | ✅ Complete | Shows T-15 prep + transcript as sources |
| **Per-Section AI Improve** | ✅ Complete | "Improve with AI" button on each section |
| **Word Processor Toolbar** | ✅ Complete | Formatting, lists, links, undo/redo |
| **Preview as Client** | ✅ Complete | Button to see client view |
| **Coach Private Notes** | ✅ Complete | Clearly marked "Not sent to client" |
...
| Feature | Status | Notes |
|---------|--------|-------|
| **Clickable Metric Cards** | ✅ Complete | All major metrics open drill-down views |
| **Engagement Analytics** | ✅ Complete | Bar charts, donut charts, trends |
| **Goal Attainment Analytics** | ✅ Complete | Funnel chart, progress by life area |
| **Revenue Analytics** | ✅ Complete | Monthly charts, service breakdown, top clients |
| **Retention Analytics** | ✅ Complete | Cohort table, churn reasons, LTV |
| **Billing & Invoicing** | ✅ Complete | Financial summary, invoice table |
...
| Feature | Status | Notes |
|---------|--------|-------|
| **6-Section Layout** | ✅ Complete | Who client is, Last session, What's alive, Check-ins, Openers, Frameworks |
| **Pre-Session Check-In** | ✅ Complete | Client's responses displayed |
| **Sage Activity Summary** | ✅ Complete | Companion usage since last session |
| **Powerful Questions** | ✅ Complete | AI-suggested questions |
| **Framework Recommendations** | ✅ Complete | Context-based suggestions |
...
| Flow | Status | Notes |
|------|--------|-------|
| **Coach Onboarding** | ✅ Complete | Multi-step with "Why We Ask" explanations |
| **Coachee Onboarding** | ✅ Complete | Simplified flow for clients |
| **Admin Onboarding** | ✅ Complete | Enterprise setup flow |
| **User Type Selection** | ✅ Complete | Coach, Coachee, Admin options |

---

## Remaining Wireframe Priorities

| Feature | Priority | Status |
|---------|----------|--------|
| Coachee Dashboard | P1 | ✅ Complete |
| Admin Dashboard | P1 | ✅ Complete |
| Resource Library | P2 | ✅ Complete |
| Settings Page | P2 | ✅ Complete |
| Schedule/Calendar Page | P2 | ✅ Complete |
...
### Priority Books to Add (Jesse's List)
...
*[Full phase details from V3 document, updated with new features]*

### Key Phase Updates from V3:

**Phase 1 Additions:**
- 24/7 coachee companion (moved earlier — core differentiator)
- Basic mobile app shell

**Phase 2 Additions:**
- Full conversation log on client page
- Coach to-do tracking (coaching AND non-coaching)
...
**Phase 4 Additions:**
- All user tier mobile apps (coach, coachee, admin)
- PayPal, Venmo, Zelle integrations

**Phase 4.5 Additions:**
- Corporate coachee features (KPIs, OKRs, team dynamics context)
- Enhanced privacy controls

**Phase 5.5 Additions:**
- In-session adjustable controls/dials
- Time keeper feature
...
**Phase 7+ Additions:**
- Meta-learning architecture
- Voice cloning/avatar (future)
- Ever-evolving corpus system

---

## Appendix C: Corporate Coachee Features

For coachees in corporate/enterprise contexts, additional features support their professional development:
...
### Manager/HR Collaboration (Optional)
- Coachee can choose to share specific goals with manager
- Progress updates (coachee-controlled)
...
3. Can mobile apps share codebase with web extension (React Native/Expo)?
4. What's the minimum viable security certification timeline?
5. RAG framework preference: LlamaIndex vs LangChain?
6. Context window management approach — validate proposed strategy
7. Third-party data privacy handling — needs design spec
8. Voice cloning consent framework — for future feature
9. Corporate admin dashboard — what metrics matter most?
10. Sentiment analysis model selection — separate research needed
...
- V4.0 — Comprehensive expansion incorporating:
  - **Workflow 5 expansion** — Full companion conversation log on client page
  ...
  - **Tier 1 autonomy expansion** (more autonomous actions)
  - **Tier 5 confidentiality clarification**
  - **Third-party privacy handling** (discussion point)
  - **Compliance phasing details**
  - **Sentiment analysis** (future integration)
  - **Time keeper feature** for in-session
  - **24/7 chatbot timing** — moved to MVP/Phase 1
  - **Meta-learning architecture** for wisdom corpus
  - **Ever-evolving wisdom corpus** design
  - **Corpus prioritization numbers** (100-500 MVP, 50-100K complete)
  - **Jesse's methodologies expanded** (Polyvagal, IFS, NVC, limiting beliefs)
  - **Foundational textbook research task**
  ...
  - **Billing integrations expanded** (PayPal, Zelle, Venmo)
  - **Legal questions expanded** (10 items)
  - **Priority books to add** (8 specific titles)
  - **Client list page** specification
  - **Scheduling/calendar page** specification
  - **Corporate admin experience** (new Part F)
- **V5.0 — Pricing & Wireframe Implementation Update:**
  - **NEW: Part N — Pricing Strategy**
    - Individual tier: $39/month (up to 25 clients)
    - Enterprise tier: $9/coachee/month (coach seats FREE)
    - "No games, no gates, no bullshit" philosophy documented
    - Anti-bullshit guarantees formalized
    - Competitive positioning analysis
  - **NEW: Part Q — Wireframe & UI Implementation Status**
    - Complete implementation status for all wireframe features
    - Goals page: Vertical columns with accordion drill-down
    - View All Goals dashboard with color-coded progress
    - Business Management: Clickable drill-down analytics pages
    - Session Notes Editor: Full editing with AI Assist dropdown
    - Smart CTAs: Context-aware onboarding routing
    - 24/7 Companion tab with privacy indicators
    - Client profiles with personality assessments & LinkedIn
    - Launch Questionnaire modal with sample data
  - **Landing Page Updates:**
    - Superhuman-style left-aligned header
    - Enterprise page messaging: "Organizations that invest in their people"
    - Pricing page: "Simple pricing. Full access. No games."
    - "What's the catch" section with values messaging
    - Help chat button added
  - **Dashboard Updates:**
    - Alerts/notifications icon with badge
    - Quick capture bar clarified: "Just talk to me..."
  - **Brand Consistency:**
    - ReGenesis = product name
    - Sage = AI assistant name (within app)
    - Core values messaging locked in throughout
